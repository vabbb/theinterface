...
static bool view_at(struct ti_xdg_view *view, double lx, double ly,
...
static struct ti_xdg_view *desktop_view_at(struct ti_server *server, double lx,
                                           double ly,
...
static void render_surface(struct wlr_surface *surface, int sx, int sy,
  ...
  struct ti_xdg_view *view = rdata->view;
